...
```{r lucid early integration setup, include = TRUE, echo = TRUE,warning = FALSE,message = FALSE}
...
#LUCIDus Version 3.0.1 was submitted to CRAN for review on 10.30.2023
library(LUCIDus)
...
```{r lucid early sankey, fig.height= 15, fig.width= 12,collapse = TRUE}
...
```{r lucid in parallel setup, include = TRUE, echo = TRUE}
...
```{r lucid in serial setup, include = TRUE, echo = TRUE}
