...
```{r 2. intermediate integration analysis}
# # Run Analysis (takes ~45 minutes)
# system.time(
# result_hima_int <- hima_intermediate_integration(omics_lst = omics_lst,
#                                                  covs = covs,
#                                                  outcome = outcome,
#                                                  exposure = exposure,
#                                                  n_boot = 12,
#                                                  Y.family = "gaussian")
# )
# # saveRDS(result_hima_int,
#         fs::path(dir_results,
#                  "2_high_dim_multivar_mediation",
#                  "HIMA_intermediate_integration_res_Hg_ck18.rds"))

result_hima_intermediate <- readRDS(
  fs::path(dir_results,
           "2_high_dim_multivar_mediation",
           "HIMA_intermediate_integration_res_Hg_ck18.rds"))
...
high_dim_res_fin <- high_dim_res_long |>
  mutate(ftr_name = if_else(omic_layer == "miRNA", 
                            paste0("hsa-", ftr_name),
                            ftr_name)) |>
