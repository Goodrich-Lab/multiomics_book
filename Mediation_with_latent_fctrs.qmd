...
source(fs::path(dir_proj, "functions","mediation_with_latent_fctrs_plot_function.R"))
...
result_med_with_latent_fctrs_early <-
  med_with_latent_fctrs_early_integration(exposure, outcome,
                                          ...
                                          fdr.level = 0.05)
# Plot
(med_with_latent_fctrs_early_integration_plot(result_med_with_latent_fctrs_early))
```
...
(med_with_latent_fctrs_intermediate_integration_plot(result_med_with_latent_fctrs_JIVE))
```
...
(med_with_latent_fctrs_late_integration_plot(result_med_with_latent_fctrs_late))
```
