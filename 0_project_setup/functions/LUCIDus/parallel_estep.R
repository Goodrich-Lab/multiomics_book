...
#' beta <- matrix(rnorm(11 * 2), nrow = 2)
#' f_GtoX(G = G, Beta_matrix = beta)
...
#' mu <- matrix(rnorm(10 * 3), nrow = 10)
#' sigma <- array(0, dim = c(10, 10, 3))
#' for(i in 1:3) {
#' sigma[, , i] <- diag(1, nrow = 10)
#' }
...
#individual postior prob for each LC of each layer
