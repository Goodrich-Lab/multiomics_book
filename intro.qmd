...
The analyses in this book rely on several custom functions. The code for extra functions are provided in [Chapter @sec-code]. 
...
In the simulated data, each 1 standard deviation increase in maternal mercury was associated with a 0.07 standard deviation increase in CK18 enzymes (@fig-lr_res), after adjusting for child age and child sex. 
