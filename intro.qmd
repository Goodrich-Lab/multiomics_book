...
The following is a list of packages that are used throughout this book that need to be loaded before any analysis. A complete list of all the packages used in the book can be found in [Chapter @sec-software].
```{r packages_loaded, message = FALSE, warning=FALSE, collapse=FALSE}
#| code-fold: show
```
